...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#newLabelModal">
...
<!-- Modal -->
<div class="modal fade" id="newLabelModal" tabindex="-1" aria-labelledby="newLabelModelLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="newLabelModalLabel">New Artist with Label</h1>
