...
<!-- Modal -->
<div class="modal fade" id="editArtistModal<?php echo $artist['artist_id']; ?>" tabindex="-1" aria-labelledby="editArtistModelLabel<?php echo $artist['artist_id']; ?>" aria-hidden="true">
