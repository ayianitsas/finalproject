...
<!-- Modal -->
<div class="modal fade" id="newArtistModal" tabindex="-1" aria-labelledby="newArtistModelLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <form method="post" action="">
        <div class="mb-3">
            <label for="aAName" class="form-label">Artist Name</label>
            <input type="text" class="form-control" id="aAName" name="aAName">
          </div>
        <div class="mb-3">
            <label for="aGenre" class="form-label">Genre</label>
